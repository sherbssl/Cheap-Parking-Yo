...
export const MinimalistParkingList: React.FC<MinimalistParkingListProps> = ({
  ...
  return (
    <div className="w-full lg:w-[420px] xl:w-[460px] h-full flex flex-col bg-[#0b1326] border-r border-[#25324d] overflow-hidden">
      {/* Header Bar */}
      <div className="p-4 border-b border-[#25324d] bg-[#0f192e] flex items-center justify-between">
        <div>
          <h2 className="text-sm font-bold text-[#F8FAFC] font-['Plus_Jakarta_Sans',sans-serif]">
            Available Locations
          </h2>
          <p className="text-[11px] text-[#94A3B8]">
            Within {radiusMeters.toLocaleString()}m of {destination || 'selected destination'}
          </p>
        </div>
        ...
        {facilities.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center p-6 text-center">
            ...
            <p className="text-xs text-[#94A3B8] mt-1.5 max-w-xs leading-relaxed">
              No car parks found within this tight radius around {destination || 'destination'}. Slide the radius up to 2,000m to discover nearby locations.
            </p>
